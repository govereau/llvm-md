...
; <label>:4                                       ; preds = %1
  %5 = load i32* %i, align 4
  %6 = sext i32 %5 to i64
  %7 = getelementptr inbounds [5 x %struct.planet]* @bodies, i32 0, i64 %6
  %8 = getelementptr inbounds %struct.planet* %7, i32 0, i32 3
  %9 = load double* %8, align 8
  %10 = fmul double %9, 3.652400e+02
  store double %10, double* %8, align 8
  %11 = load i32* %i, align 4
  %12 = sext i32 %11 to i64
  %13 = getelementptr inbounds [5 x %struct.planet]* @bodies, i32 0, i64 %12
  %14 = getelementptr inbounds %struct.planet* %13, i32 0, i32 4
  %15 = load double* %14, align 8
  %16 = fmul double %15, 3.652400e+02
  store double %16, double* %14, align 8
  %17 = load i32* %i, align 4
  %18 = sext i32 %17 to i64
  %19 = getelementptr inbounds [5 x %struct.planet]* @bodies, i32 0, i64 %18
  %20 = getelementptr inbounds %struct.planet* %19, i32 0, i32 5
  %21 = load double* %20, align 8
  %22 = fmul double %21, 3.652400e+02
  store double %22, double* %20, align 8
  %23 = load i32* %i, align 4
  %24 = sext i32 %23 to i64
  %25 = getelementptr inbounds [5 x %struct.planet]* @bodies, i32 0, i64 %24
  %26 = getelementptr inbounds %struct.planet* %25, i32 0, i32 6
  %27 = load double* %26, align 8
  %28 = fmul double %27, 0x4043BD3CC9BE45DE
...
; <label>:12                                      ; preds = %7, %6
  ...
  %14 = call double @energy(i32 5, %struct.planet* getelementptr inbounds ([5 x %struct.planet]* @bodies, i32 0, i32 0))
...
; <label>:24                                      ; preds = %16
  %25 = call double @energy(i32 5, %struct.planet* getelementptr inbounds ([5 x %struct.planet]* @bodies, i32 0, i32 0))
  %26 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([6 x i8]* @.str, i32 0, i32 0), double %25)
  ret i32 0
}
