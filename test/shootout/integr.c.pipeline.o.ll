...
; <label>:4                                       ; preds = %6, %0
  %x.0 = phi double [ %low, %0 ], [ %10, %6 ]
  %s.0 = phi double [ 0.000000e+00, %0 ], [ %8, %6 ]
  %i.0 = phi i32 [ %n, %0 ], [ %9, %6 ]
...
; <label>:6                                       ; preds = %4
  ...
  %8 = fadd double %s.0, %7
  %9 = add nsw i32 %i.0, -1
  %10 = fadd double %x.0, %3
  br label %4

; <label>:11                                      ; preds = %4
  %s.0.lcssa = phi double [ %s.0, %4 ]
  %12 = fmul double %s.0.lcssa, %3
  ret double %12
}
